...
def fitting(docList,wordDic,stumpInfo):
    ...
    return stumpInfo,wordDic

def calcPF(docList,stumpInfo):
    feat=stumpInfo[0][0]
    ...
    for doc in docList:
        ...
        z0=(0-stumpInfo[1][bag])/(eps+stumpInfo[1][bag]*(1-stumpInfo[1][bag]));print 'z0',z0,doc[2],doc[3][0]
        z1=(1-stumpInfo[1][bag])/(eps+stumpInfo[1][bag]*(1-stumpInfo[1][bag]));print 'z1',z1
        i=0
        F1=doc[5];initialF2=0.5
        ...
        doc[5]=[F2,pi];print doc[5]
        ################fm
        fm=F2-F1;print 'fm',fm
